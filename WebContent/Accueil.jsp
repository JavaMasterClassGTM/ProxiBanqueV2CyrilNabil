					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">Bienvenue Conseiller</h4>
							</div>
							<div class="modal-body">
								<p class="centered">
									<img class="img-circle" width="300" src="assets/img/ui-sam.jpg">
								</p>
							...
							<div class="modal-footer centered">
								...
								<button class="btn btn-theme03" type="button">
									<a href="Home.jsp">Se connecter </a>
								</button>
							</div>
						</div>
					</div>
