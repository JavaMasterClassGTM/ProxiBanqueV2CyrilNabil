...
<body>
	...
	<!--main content start--> <section id="main-content"> <section
		class="wrapper">
	<h3>
		<i class="fa fa-angle-right"></i> Gestion des virements
	</h3>
	...
	<div class="row mt">
		<div class="col-lg-12">
			<div class="form-panel">
				<h4 class="mb">
					<i class="fa fa-angle-right"></i> Compte Débiteur
				</h4>
				<form class="form-horizontal style-form" method="get">
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Nom du
							Client</label>
						<div class="col-sm-10">
							<input type="text" class="form-control round-form">
						</div>
						<label class="col-sm-2 col-sm-2 control-label">Numéro de
							Compte</label>
						<div class="col-sm-10">
							<input type="text" class="form-control round-form"> <select
								name="SelecteurCompte">
				...
				<h4 class="mb">
					<i class="fa fa-angle-right"></i> Montant
				</h4>
				<form class="form-horizontal style-form" method="get">
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Somme à
							virer</label>
						<div class="col-sm-10">
							<input type="text" class="form-control round-form">
						</div>
				...
				<h4 class="mb">
					<i class="fa fa-angle-right"></i> Compte Receveur
				</h4>
				<form class="form-horizontal style-form" method="get">
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Nom du
					...
					<button class="btn btn-theme" href="#" type="submit">
						<i class="fa"></i> Effectuer le virement
					</button>
				</form>
			</div>
		</div>
